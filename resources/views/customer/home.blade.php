...
<section class="cust-section cust-home-block cust-home-bands">
    <div class="cust-band">
        ...
        <a href="{{ route('menu') }}" class="cust-band__media cust-click-card">
            <x-ph label="Packed delivery bags" :src="\App\Support\StockImages::forLabel('packed delivery bags')" :h="380" :r="18" style="border:none" />
        </a>
    ...
    <div class="cust-band cust-band--reverse">
        ...
        <a href="{{ route('reserve') }}" class="cust-band__media cust-click-card">
            <x-ph label="Dining room on Aurora Ave" :src="\App\Support\StockImages::forLabel('dining room')" :h="380" :r="18" style="border:none" />
        </a>
        <div class="cust-band__body">
