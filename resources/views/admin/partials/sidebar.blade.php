...
$nav = [
    ['group' => 'Operations', 'items' => [
        ...
        ['id' => 'contact', 'label' => 'Contact', 'icon' => 'mail', 'badge' => $badges['contact'] ?? 0, 'route' => 'admin.inquiries.index'],
    ]],
    ['group' => 'Content', 'items' => [
        ['id' => 'menu', 'label' => 'Menu', 'icon' => 'fork', 'route' => 'admin.menu.index'],
        ['id' => 'promos', 'label' => 'Offers', 'icon' => 'tag', 'route' => 'admin.promos.index'],
        ['id' => 'content', 'label' => 'Home page', 'icon' => 'file', 'route' => 'admin.content.index'],
        ['id' => 'about', 'label' => 'About', 'icon' => 'users', 'route' => 'admin.about.index'],
