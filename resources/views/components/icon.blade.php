@props(['name', 'size' => 20, 'stroke' => 1.75, 'color' => null])
...
$paths = [
    ...
    'eyeOff' => 'M17.9 17.9A10 10 0 0 1 12 20C5 20 1 12 1 12a18.8 18.8 0 0 1 5.1-7.1M9.9 9.9a3 3 0 1 0 4.2 4.2M22 12s-3.5-7-10-7a10 10 0 0 0-5.3 1.5M3 3l18 18',
...
<svg width="{{ $size }}" height="{{ $size }}" viewBox="0 0 24 24"
     ...
     style="flex-shrink:0;{{ $attributes->get('style') }}"
