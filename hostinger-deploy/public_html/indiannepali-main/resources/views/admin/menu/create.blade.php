...
<div style="max-width:640px;">
    <div style="margin-bottom:26px;">
        ...
        <h1 style="font-size:30px;font-weight:600;">Add menu item</h1>
        <p style="color:var(--muted);font-size:14.5px;margin-top:6px;">Create a new dish for the customer menu.</p>
    </div>
