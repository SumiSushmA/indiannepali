...
<div class="adm-card" style="padding:22px;margin-bottom:18px;">
    ...
    <form action="{{ route('admin.about.hero.update') }}" method="POST" enctype="multipart/form-data" style="margin-bottom:20px;padding-bottom:20px;border-bottom:1px solid var(--line-soft);">
        ...
        <div style="display:flex;gap:16px;flex-wrap:wrap;align-items:flex-start;">
            <div style="width:120px;height:90px;border-radius:10px;overflow:hidden;background:var(--ink-800);border:1px solid var(--line);flex-shrink:0;">
                @if($heroImage)
            ...
            <div class="adm-file-field" style="flex:1;min-width:min(100%,280px);">
            ...
            <button type="submit" class="btn btn-gold btn-sm" style="align-self:flex-end;">Upload photo</button>
        </div>
    </form>
