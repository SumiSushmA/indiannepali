...
class LiveSiteContent
{
    public static function settings(): array
    {
        return [
            ...
            'about_hero_image_path' => 'images/dining-spread.jpeg',
        ];
    }
    ...
    public static function galleryCategories(): array
    {
        return [
            ...
            ['id' => 'space', 'name' => 'The Restaurant', 'items' => [
                'Dining spread', 'Chicken Momo', 'Chana Masala', 'Veg sides', 'Lassi',
            ]],
        ];
    }
    ...
    public static function menu(): array
    {
        return [
            ...
            'items' => [
                ...
                ['id' => 'taas', 'cat' => 'nepali-special', 'name' => 'Taas', 'price' => 17.99, 'veg' => false, 'spice' => 2, 'popular' => true, 'desc' => 'Spiced grilled meat with seasoned puffed rice, cucumber, carrot and onion.', 'img' => 'Taas'],
                ...
                // Salad & Soup
                ['id' => 'green-salad', 'cat' => 'salad', 'name' => 'Fresh Green Salad', 'price' => 7.95, 'veg' => true, 'spice' => 0, 'popular' => true, 'desc' => 'Cucumber, onion, tomato, lettuce, carrots and chickpeas.', 'img' => 'Green Salad'],
